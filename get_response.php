...
switch($res_type)
{
    ...
    break;
    case "REGISTER":
        $jobj= register($_POST["PNAME"],$_POST["USERNAME"],$_POST["EMAIL"],$_POST["GENDER"],$_POST["PASSWORD"],$_POST["MOBILE"],$_POST["CITY"]);
        echo json_encode($jobj);
    break;
    case "LOGIN":
    ...
    break;
    case "APPLY": 
        $jobj = apply($_POST["EXP"], $_POST["PACKAGE"],$_POST["LOC"],$_POST["SKILLS"],$_POST["ID"]);
        echo json_encode($jobj);
        break;
}
